# NAPI FrontControl Current Gathering 
...
:pick_up: /dev/ttyS0 - консоль ввода\вывода
...
Параметры порта задаются поделюаемым датчиком
 ```
:pick_up: /dev/ttyS2 — LORA модем RAK3172. 
```
Параметры порта
115200,8,n,1
```
:pick_up: /dev/ttyS1 — Датчик тока и напряжения
